...
class ParserRegistry
{
    ...
    /**
     * Register a custom parser by name with the register.blade.php
     *
     * @param string $name   Name or handle of the parser to register.blade.php
     * @param mixed  $parser Instantiated parser to register.blade.php
     */
