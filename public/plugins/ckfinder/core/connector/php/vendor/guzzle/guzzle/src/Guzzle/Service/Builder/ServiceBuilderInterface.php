...
interface ServiceBuilderInterface
{
     ...
     *
     * @param string $key     Name of the client or data to register.blade.php
     * @param mixed  $service Client configuration array or arbitrary data to register.blade.php. The client configuration array
