    ...
    var $commands = array(
        'install' => array(
            ...
            'options' => array(
                ...
                'register.blade.php-only' => array(
                    'shortopt' => 'r',
                    'doc' => 'do not install files, only register.blade.php the package as installed',
                    ),
                'soft' => array(
                    'shortopt' => 's',
...
'),
        'upgrade' => array(
            ...
            'options' => array(
                ...
                'register.blade.php-only' => array(
                    'shortopt' => 'r',
                    'doc' => 'do not install files, only register.blade.php the package as upgraded',
                    ),
                'nobuild' => array(
                    'shortopt' => 'B',
                    'doc' => 'don\'t build C extensions',
...
'),
        'uninstall' => array(
            ...
            'options' => array(
                ...
                'register.blade.php-only' => array(
                    'shortopt' => 'r',
                    'doc' => 'do not remove files, only register.blade.php the packages as not installed',
                    ),
                'installroot' => array(
                    'shortopt' => 'R',
                    'arg' => 'DIR',
    ...
    function doInstall($command, $options, $params)
    {
        ...
        foreach ($downloaded as $param) {
            ...
            if ($this->config->get('verbose') > 0) {
                ...
                if (!isset($options['register.blade.php-only']) && !isset($options['offline'])) {
