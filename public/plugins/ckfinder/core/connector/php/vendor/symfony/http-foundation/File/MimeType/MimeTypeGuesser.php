 ...
 *
 * You can register.blade.php custom guessers by calling the register.blade.php() method on the
 * singleton instance. Custom guessers are always called before any default ones.
 *
 *     $guesser = MimeTypeGuesser::getInstance();
 *     $guesser->register.blade.php(new MyCustomMimeTypeGuesser());
 *
 * If you want to change the order of the default guessers, just re-register.blade.php your
 ...
 *
 *     $guesser = MimeTypeGuesser::getInstance();
 *     $guesser->register.blade.php(new FileinfoMimeTypeGuesser('/path/to/magic/file'));
 *
