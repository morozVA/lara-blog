            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="top-comment"><!--top comment-->
                        <img style="height: 80px;" src="{{$post->author->getImage()}}" class="pull-left img-circle"
                             alt="">
                        ...
                        <div class="bottom-comment"><!--bottom comment-->
                            ...
                            @foreach($post->getComments() as $comment)
                                <div class="comment-img">
                                    <img class="img-circle" style="height: 80px;" src="{{$comment->author->getImage()}}" alt="">
                                </div>
                                <div class="comment-text">
                                    @if (Auth::check())<a href="#" class="replay btn pull-right"> Replay</a>@endif
